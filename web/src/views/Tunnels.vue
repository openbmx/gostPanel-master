          ...
          <el-col :span="12">
            <el-form-item label="传输协议" prop="protocol">
              <el-select v-model="form.protocol" style="width: 100%">
                ...
                <el-option label="Multiplex WebSocket (mws)" value="mws" />
                <el-option label="Multiplex WSS (mwss)" value="mwss" />
                <el-option label="HTTP/2 (h2)" value="h2" />
                <el-option label="gRPC" value="grpc" />
                <el-option label="QUIC" value="quic" />
                <el-option label="KCP" value="kcp" />
                <el-option label="TLS" value="tls" />
                <el-option label="Multiplex TLS (mtls)" value="mtls" />
                <el-option label="SSH" value="ssh" />
                <el-option label="TCP (tcp)" value="tcp" />
              </el-select>
              <div class="form-hint">节点间通信的传输层协议，建议使用 ws/wss</div>
            </el-form-item>
          </el-col>
          <el-col :span="12">
